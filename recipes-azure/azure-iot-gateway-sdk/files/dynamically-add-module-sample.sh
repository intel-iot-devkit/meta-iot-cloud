...
echo ---------- Building the Dynamically Load Module Gateway SDK sample ----------
gcc src/main.c --std=c99 -I/usr/include/azureiot -L. -lgateway -laziotsharedutil -lnanomsg -o "$build_dir"/"$output_name"
[ $? -eq 0 ] || exit $?
