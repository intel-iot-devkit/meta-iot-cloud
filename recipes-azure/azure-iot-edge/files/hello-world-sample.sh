...
echo ---------- Building the Hello World IoT Edge sample ----------
gcc src/main.c --std=c99 -I/usr/include/azureiot -I/usr/include/azureiotedge -L. -lgateway -laziotsharedutil -o "$build_dir"/"$output_name"
[ $? -eq 0 ] || exit $?
