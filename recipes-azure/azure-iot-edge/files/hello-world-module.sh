...
echo ---------- Building the Hello World IoT Edge module ----------
gcc -c -fPIC -std=c99 src/"$output_name".c -I/usr/include/azureiot -I/usr/include/azureiotedge -I/usr/include/azureiot/modules/common -Iinc -o "$build_dir"/"$output_name".o
[ $? -eq 0 ] || exit $?
